...
class TestCLITranscribeCommand(E2ETestBase, CLITestMixin, MockProviderMixin):
    ...
    def test_transcribe_auto_provider_selection(self):
        ...
        # Set up mock environment with multiple providers
        self.set_test_env(
    ...
    def test_transcribe_large_file_handling(self):
        ...
        # This test would use edge_large file if available
        ...
        # Should either succeed or fail with file size message
        if not result.success:
...
class TestCLIProcessCommand(E2ETestBase, CLITestMixin, MockProviderMixin):
    ...
    def test_process_full_pipeline(self):
        ...
        # Mock the transcription and analysis services
    ...
    def test_process_with_verbose_output(self):
        ...
        # With verbose flag, should have more detailed output
...
class TestCLIEdgeCases(E2ETestBase, CLITestMixin):
    ...
    def test_unicode_filename_handling(self):
        ...
        if not result.success:
            # Error should not be due to filename encoding issues
    ...
    def test_help_command(self):
        ...
        # Help should return success and show usage information
    ...
    def test_version_command(self):
        ...
        # Version should return success and show version info
